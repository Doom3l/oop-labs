...
public class SmallTorusMapTests
{
    ...
    public void Constructor_ValidSize_ShouldSetSize()
    {
        ...
        // Assert
        Assert.Equal(x, map.SizeX);
        Assert.Equal(y, map.SizeY);
    }
    ...
    [InlineData(0, 0, Direction.Down, 0, -1)]   // raw result before wrap
    [InlineData(0, 8, Direction.Left, -1, 8)]
    [InlineData(9, 10, Direction.Right, 10, 10)]
    public void Next_Raw_ShouldMoveCorrectly(int x, int y,
